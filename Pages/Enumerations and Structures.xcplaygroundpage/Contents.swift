...
func compareRanks(rank1: Int, rank2: Int) -> Bool {
    return rank1 == rank2
}
...
let kingDescription = king.simpleDescription()

let kingRawValue = king.rawValue
let queenRawValue = queen.rawValue

print(compareRanks(rank1: kingRawValue, rank2: queenRawValue))
...
let heartColor = Suit.hearts.color()
...
let pending = ServerResponse.pending("Loading")
let success = ServerResponse.result("6:00 am", "8:09 pm")
let failure = ServerResponse.failure("Out of cheese.")

switch success {
    case let .pending(message):
        print("Sunrise is processing... \(message)")
